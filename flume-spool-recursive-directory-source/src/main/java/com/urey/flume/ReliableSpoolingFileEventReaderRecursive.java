...
public class ReliableSpoolingFileEventReaderRecursive implements ReliableEventReader {

  private static final Logger logger = LoggerFactory
      .getLogger(ReliableSpoolingFileEventReaderRecursive.class);
  ...
  */
   ...
   */
  private ReliableSpoolingFileEventReaderRecursive(File spoolDirectory,
    ...
    if (logger.isDebugEnabled()) {
      logger.debug("Initializing {} with directory={}, metaDir={}, " +
          "deserializer={}",
          new Object[] { ReliableSpoolingFileEventReaderRecursive.class.getSimpleName(),
...
//      candidateFiles = Arrays.asList(spoolDirectory.listFiles(filter));
  ...
  public static class Builder {
    ...
    public ReliableSpoolingFileEventReaderRecursive build() throws IOException {
      return new ReliableSpoolingFileEventReaderRecursive(spoolDirectory, completedSuffix,
